...
#define VERSION  "UnZip:  Zipfile Extract v2.1 (C) of 11-18-92;  Copyright 1989 Samuel H. Smith"
                ...
                char *s)
{
        ...
        s[n] = 0;
        if (len > STRSIZE-1)
                lseek(zipfd, len-STRSIZE+1, SEEK_CUR);
}
...
{
	if (argc != 2) {
                printf("\n%s\nCourtesy of:  S.H.Smith  and  The Tool Shop BBS,  (818) 891-6780.\n\n",VERSION);
